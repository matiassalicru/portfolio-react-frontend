  ...
  return (
    <div className="about">
      ...
      <div className="about-me">
        ...
        apasionado por la tecnología, llevo varios meses aprendiendo a
        programar <span>(desde febrero 2020)</span> en ese tiempo
        hice algunos proyectos personales que me fueron divertidos de crear, de los cuales aprendí
        mucho, en ellos llegué a utilizar tecnologías como HTML5 y CSS3, Git, JavaScript,
        ReactJS y Node, siempre es bien recibido el feedback y cualquier opinión
        que me ayude a llegar a mi meta de ser desarrollador Full-Stack.
        <br></br> <span>PD: Tambien me gustan los gatos y andar en bici</span>
      </div>

      <div className="about-me-extra">
        <p>
          Estas son algunas de las tecnologías que más utilizo actualmente:
        </p>
